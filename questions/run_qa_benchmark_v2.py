...
QUESTIONS = [
    ...
    "11. YOGA600 discount code lene ke liye exact 3 steps batao, kya ye code bina app profile banaye direct chat par use ho sakta hai?",
    ...
    "94. How do I get the welcome discount coupon YOGA600, what code is it, and what are the exact 3 steps to claim it?",

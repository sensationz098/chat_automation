...
QUESTIONS = [
    ...
    "11. Welcome discount code lene ke liye exact 3 steps batao, kya ye code bina app profile banaye direct chat par use ho sakta hai?",
    ...
    "94. How do I get the welcome discount coupon codes, what codes are there for 1 month vs other durations, and what are the exact 3 steps to claim them?",
